package homeworks;// Stworz 3 obiekty klasy student. Przypisz wartosci do pol. Stworz tablice i dodaj studentow do tablicy.
...
public class PracaDomowa4_StudentChecker {
    ...
    public static void main(String[] args) {
        ...
        /*Package1.Student[] studenci = new Package1.Student[3];
        studenci[0] = student1;
        studenci[1] = student2;
        studenci[2] = student3;*/
